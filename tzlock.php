...
function tzLockReplace($match)
{
  ...
  if (isset($pass) && ($dbrow = $GLOBALS["wpdb"]->get_row("SELECT * FROM tzlock_plugin WHERE lock_id='$lockid' AND lock_pass = '$pass'")));
...
{
  $sql = "CREATE TABLE tzlock_plugin
  (
